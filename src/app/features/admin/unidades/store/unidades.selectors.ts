...
// LIST
export const selectUnidades = createSelector(selectUnidadesState, (s) => s.list.unidades);
...
export const selectUnidadesError = createSelector(selectUnidadesState, (s) => s.list.status.error);

export const selectUnidadesEntities = createSelector(selectUnidades, (unidades) =>
